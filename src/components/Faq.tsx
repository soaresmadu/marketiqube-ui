            ...
            <div className="w-[1200px]">
                ...
                <div className="w-full mt-7 flex flex-col gap-4">
                    {questions.map((item, index) => (
                        ...
                        >
                            <div
                                className="p-4 flex justify-between items-center rounded-xl hover:bg-gray-100 transition-colors"
                                onClick={() => toggleQuestion(index)}
                            >
                                <p className="text-[18px] font-medium text-[#1C1C1E]">{item.question}</p>
                                <span className="text-xl text-[#1C1C1E]">
                            ...
                            {openIndex === index && (
                                <div className="p-4 w-full border-t border-gray-300">
                                    <p className="mt-2 text-[17px] font-medium text-gray-700">
                                        {item.answer}
                                    </p>
                                </div>
                            )}
