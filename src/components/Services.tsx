            ...
            <div className="mt-10 mb-10 w-full flex justify-center items-center">
                <div className="w-[1200px]">
                    <div className="w-[900px]">
                        <button className="mb-4 w-[280px] h-auto py-1 px-3 border border-gray-300 rounded-full shadow-xs bg-white font-semibold text-gray-900">Alguns dos nossos serviços</button>
